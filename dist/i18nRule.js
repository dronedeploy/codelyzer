...
var I18NAttrVisitor = (function (_super) {
    ...
    I18NAttrVisitor.prototype.visitAttr = function (attr, context) {
        if (attr.name === 'i18n') {
            ...
            if (parts[0].length === 0) {
                var span = attr.sourceSpan;
                context.addFailure(context.createFailure(span.start.offset, span.end.offset - span.start.offset, 'Missing title+description for i18n attribute i18n="title|description@@customLabel"'));
            }
        }
